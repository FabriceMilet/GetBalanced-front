    ...
    return (
        <div className="area2_container">
            <div className="top_container">
                <h2 className='top_container_title'> <span className='animation'>Get Balanced</span> , pour une répartition équitable des tâches</h2>
            </div>
            <div className="bottom_container">
                <img className='logoArea2' src={équité} alt="logo d'illustration" />
